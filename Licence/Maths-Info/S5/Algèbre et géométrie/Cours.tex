...
\subparagraph{Élément neutre :} On cherche $\fun{\epsilon}{G}{\mathbb{Z}}$ tel que
...
Soit $\fun{f}{G}{\mathbb{Z}}$, il existe $\fun{\phi}{G}{\mathbb{Z}}$ telle que $f \otimes \phi = \phi \otimes f = \epsilon$
